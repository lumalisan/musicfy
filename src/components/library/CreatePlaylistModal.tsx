...
export const CreatePlaylistModal = () => {
  ...
  return (
    ...
    >
      ...
      <Dialog.Portal>
        <Dialog.Overlay className='bg-primary/80 data-[state=open]:animate-overlayShow fixed inset-0 z-50' />
        <Dialog.Content className='bg-secondary fixed top-1/2 left-1/2 z-50 max-h-[90vh] w-[90vw] max-w-lg -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-lg p-6 shadow-xl focus:outline-none'>
