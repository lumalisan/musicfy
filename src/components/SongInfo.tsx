...
const SongInfo = ({ playlist, songs, song, idx }: Props) => {
  ...
  return (
    <tr
      className='border-spacing-0 cursor-pointer overflow-hidden text-sm font-light text-accent transition duration-300 hover:bg-accent/10'
      onClick={handleClick}
    >
      ...
      <td className='flex gap-3 px-4 py-2'>
        ...
        <div className='flex flex-col'>
          <h3 className='text-base font-normal text-accent'>{song.title}</h3>
