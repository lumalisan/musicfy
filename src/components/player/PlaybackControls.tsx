    ...
    return (
        <div className='flex items-center justify-center gap-4'>
            <button
                ...
                onClick={() => playerControlService.handleShuffle(isRandom, setIsRandom)}
            >
            ...
            <button
                ...
                onClick={() => playerControlService.handlePrevious(currentMusic, setCurrentMusic)}
            >
            ...
            <button
                className='text-accent/40 hover:text-accent p-2 text-xl transition duration-300'
                onClick={() => playerControlService.handleNext(currentMusic, setCurrentMusic)}
            >
